...
def execute(
    ...
    *,
    ...
    """Submit to the one credential-isolated authority; never POST locally."""
    del journal, renderer
    from .authority_client import execute as authority_execute

    return authority_execute(
        thread_id,
        draft_id,
        delay=delay,
        account=account,
